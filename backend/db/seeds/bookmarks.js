...
export const DUMMY_BOOKMARK_CATEGORIES = [
  { uid: "ktGDhX", parent_uid: "0", title: "Несортированные", icon: "Inbox", position: 0 },
  { uid: "wxiqnC", parent_uid: "0", title: "Корзина", icon: "Trash", position: 0 },
  { uid: "0", parent_uid: "", title: "Системные", icon: "", position: -2 },
  { uid: "wTOx", parent_uid: "", title: "Работа", icon: "", position: -1 },
  { uid: "tVhm", parent_uid: "wTOx", title: "Инструменты", icon: "Folder", position: 2 },
  { uid: "IpYb", parent_uid: "", title: "Основное", icon: "", position: -1 },
  { uid: "4x3o", parent_uid: "IpYb", title: "Рецепты", icon: "Folder", position: 3 },
  { uid: "7i95", parent_uid: "IpYb", title: "Игры", icon: "Rocket", position: 0 },
  { uid: "mKgw", parent_uid: "IpYb", title: "Хочу прочитать", icon: "Folder", position: 6 },
  { uid: "V8dU", parent_uid: "IpYb", title: "Хочу посмотреть", icon: "Film", position: 7 },
  ...
  { uid: "HWt3", parent_uid: "wTOx", title: "Letoile", icon: "UserGroup", position: 0 },
  { uid: "l15e", parent_uid: "IpYb", title: "Инструменты", icon: "Folder", position: 2 },
  { uid: "ghhl", parent_uid: "IpYb", title: "MyApp", icon: "Folder", position: 1 },
  { uid: "F6O2", parent_uid: "IpYb", title: "Хочу пересмотреть", icon: "Film", position: 8 },
  { uid: "Vzgd", parent_uid: "IpYb", title: "Хочу поиграть", icon: "Folder", position: 5 },
  { uid: "gKdY", parent_uid: "IpYb", title: "Sur Ron", icon: "Folder", position: -1 },
  { uid: "j5cG", parent_uid: "IpYb", title: "Велосипед", icon: "Folder", position: -1 },
  { uid: "ie4p", parent_uid: "IpYb", title: "LG", icon: "Folder", position: -1 },
  { uid: "wai5", parent_uid: "IpYb", title: "OnePlus 13R", icon: "Folder", position: -1 },
  { uid: "SVSZ", parent_uid: "IpYb", title: "Кофе", icon: "Folder", position: -1 },
  { uid: "euMD", parent_uid: "IpYb", title: "AI", icon: "Folder", position: -1 },
  { uid: "eH1u", parent_uid: "wTOx", title: "Поиск 2025", icon: "Folder", position: -1 },
];

export const DUMMY_BOOKMARK_TAGS = [
  { uid: "GE20b", title: "Срочно" },
  { uid: "7t78v", title: "Крылышки" },
  ...
  { uid: "mgjD0", title: "Сэндвич" },
  { uid: "ZJf5O", title: "Стейк" },
  { uid: "BXaLC", title: "Helldivers 2" },
  { uid: "ljFAI", title: "Где кататься" },
  { uid: "HY1CR", title: "Фасоль" },
  { uid: "e0C39", title: "Яйца" },
  { uid: "ymCVP", title: "Кофе" },
  { uid: "IN7Ob", title: "Ростбиф" },
