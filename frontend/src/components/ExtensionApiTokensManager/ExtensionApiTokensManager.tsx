...
import "./ExtensionApiTokensManager.css";

const ExtensionApiTokensManager: React.FC = () => {
  ...
  return (
    <SingleColumnLayout>
      <div className="extension-api-tokens-manager">
        <div className="extension-api-tokens-manager__header">
          <div>
            <h1>Ключи для расширения</h1>
            <p>Создание и управление ключами для авторизации браузерного расширения по работе с закладками.</p>
          </div>
          <Button type="primary" shape="round" onClick={handleCreate} loading={creating}>
            Сгенерировать ключ
          </Button>          
        </div>
...
export default ExtensionApiTokensManager;