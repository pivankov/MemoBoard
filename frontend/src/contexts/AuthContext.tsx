 ...
 *
 * Хранит публичное состояние авторизации (текущий пользователь).
 * Access-токен не выставляется в контекст — он живёт только в AuthProvider
 * и передаётся через заголовки API-клиента.
